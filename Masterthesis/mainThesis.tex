...
\input{misc/synopsis_german_csch}   %%% MANDATORY: introduction, summary and outlook (a complete synopsis) in german
...
\input{chapter/analyticalframework}

\input{chapter/numericalframework}

\input{chapter/experiment}

\input{chapter/analyticalresults}

\input{chapter/numericalresults}
